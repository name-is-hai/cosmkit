...
source "$COSMKIT_HOME/bin/cosmkit-setup-fonts"
source "$COSMKIT_HOME/bin/cosmkit-setup-cosmic"
source "$COSMKIT_HOME/bin/cosmkit-setup-autostart"
source "$COSMKIT_HOME/bin/cosmkit-setup-fcitx5"
source "$COSMKIT_HOME/bin/cosmkit-setup-mimeapps"
